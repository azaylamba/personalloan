...
You have to design & build the backend for the application and the ability for the users to register, check for loans and take loans.
...
https://github.com/azaylamba/personalloan 
